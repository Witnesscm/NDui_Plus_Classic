...
L["EnhancedTalentUITip"] = "Click the arrow on Talent UI UI to toggle."
...
L["RaidPetFrame"] = "RaidPet Frame"
L["RaidPetPerColumn"] = "Pets Per Column"
L["RaidPetMaxColumns"] = "Max Columns"